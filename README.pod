...
=head1 The App::bgt module

This is the I<README> for the L<App::bgt> Perl module.
...
To read about L<App::bgt>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/App/bgt.pm
...
L<MetaCPAN|http://www.metacpan.org/pod/App::bgt>.
...
the source repository: L<https://github.com/briandfoy/app-bgt>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/briandfoy/app-bgt/issues>.
...
=item * L<https://bitbucket.com/briandfoy/app-bgt>

=item * L<https://codeberg.org/briandfoy/app-bgt>

=item * L<https://gitlab.com/briandfoy/app-bgt>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify App::bgt-1.23.tar.gz --owner briandfoy
